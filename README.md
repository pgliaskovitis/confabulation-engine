...
The confabulation project was originally developed primarily in QtCreator. Project files for QtCreator are available.

In order to build the project independently of QtCreator you will need the qmake facility:
...
Another way to build is through cmake:
...
However the project is built, i.e., either within QtCreator or with CMake or with regular make, please ensure that the produced
