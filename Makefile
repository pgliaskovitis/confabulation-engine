...
# Generated by qmake (3.0) (Qt 5.1.1) on: Tue Jul 15 14:06:33 2014
# Project:  ConfabulationEngine.pro
# Template: app
# Command: /home/set/Qt5.1.1/5.1.1/gcc_64/bin/qmake -spec linux-g++ -o Makefile ConfabulationEngine.pro
#############################################################################
...
CXXFLAGS      = -pipe -std=c++11 -O3 -Wall -W $(DEFINES)
INCPATH       = -I../../Qt5.1.1/5.1.1/gcc_64/mkspecs/linux-g++ -I.
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-rpath,/home/set/Qt5.1.1/5.1.1/gcc_64
LIBS          = $(SUBLIBS)  
AR            = ar cqs
RANLIB        = 
...
Makefile: ConfabulationEngine.pro ../../Qt5.1.1/5.1.1/gcc_64/mkspecs/linux-g++/qmake.conf ../../Qt5.1.1/5.1.1/gcc_64/mkspecs/features/spec_pre.prf \
		...
		../../Qt5.1.1/5.1.1/gcc_64/mkspecs/features/lex.prf \
		ConfabulationEngine.pro
	$(QMAKE) -spec linux-g++ -o Makefile ConfabulationEngine.pro
...
NGramHandler.o: NGramHandler.cpp NGramHandler.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o NGramHandler.o NGramHandler.cpp
